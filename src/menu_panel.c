...
MENU_DESCRS(panel_menu_descrs) {
    MENU_DESCR(0, 0, menu_text_di, 0, 0, 0, 0, 0),
        MENU_DESCR(1, 0, menu_text_di_out_0, 0, 0, 0, 0, 0),
            MENU_DESCR(2, APP_REG_ID_DIGITAL_IN_SELECT0, menu_text_sel, 0, 0, 0, 0, &menu_val_digital_in_select),
            MENU_DESCR(2, APP_REG_ID_DIGITAL_IN_INVERT0, menu_text_inv, 0, 0, 0, 0, &menu_val_digital_inversion),
            MENU_DESCR(2, 0, menu_text_flt, 0, 0, 0, 0, 0),
        MENU_DESCR(1, 0, menu_text_di_out_1, 0, 0, 0, 0, 0),
            MENU_DESCR(2, APP_REG_ID_DIGITAL_IN_SELECT1, menu_text_sel, 0, 0, 0, 0, &menu_val_digital_in_select),
            MENU_DESCR(2, APP_REG_ID_DIGITAL_IN_INVERT1, menu_text_inv, 0, 0, 0, 0, &menu_val_digital_inversion),
            MENU_DESCR(2, 0, menu_text_flt, 0, 0, 0, 0, 0),
        MENU_DESCR(1, 0, menu_text_di_out_2, 0, 0, 0, 0, 0),
            MENU_DESCR(2, APP_REG_ID_DIGITAL_IN_SELECT2, menu_text_sel, 0, 0, 0, 0, &menu_val_digital_in_select),
            MENU_DESCR(2, APP_REG_ID_DIGITAL_IN_INVERT2, menu_text_inv, 0, 0, 0, 0, &menu_val_digital_inversion),
            MENU_DESCR(2, 0, menu_text_flt, 0, 0, 0, 0, 0),
        MENU_DESCR(1, 0, menu_text_di_out_3, 0, 0, 0, 0, 0),
            MENU_DESCR(2, APP_REG_ID_DIGITAL_IN_SELECT3, menu_text_sel, 0, 0, 0, 0, &menu_val_digital_in_select),
            MENU_DESCR(2, APP_REG_ID_DIGITAL_IN_INVERT3, menu_text_inv, 0, 0, 0, 0, &menu_val_digital_inversion),
            MENU_DESCR(2, 0, menu_text_flt, 0, 0, 0, 0, 0),
        MENU_DESCR(1, 0, menu_text_di_out_4, 0, 0, 0, 0, 0),
            MENU_DESCR(2, APP_REG_ID_DIGITAL_IN_SELECT4, menu_text_sel, 0, 0, 0, 0, &menu_val_digital_in_select),
            MENU_DESCR(2, APP_REG_ID_DIGITAL_IN_INVERT4, menu_text_inv, 0, 0, 0, 0, &menu_val_digital_inversion),
            MENU_DESCR(2, 0, menu_text_flt, 0, 0, 0, 0, 0),
        MENU_DESCR(1, 0, menu_text_di_out_5, 0, 0, 0, 0, 0),
            MENU_DESCR(2, APP_REG_ID_DIGITAL_IN_SELECT5, menu_text_sel, 0, 0, 0, 0, &menu_val_digital_in_select),
            MENU_DESCR(2, APP_REG_ID_DIGITAL_IN_INVERT5, menu_text_inv, 0, 0, 0, 0, &menu_val_digital_inversion),
            MENU_DESCR(2, 0, menu_text_flt, 0, 0, 0, 0, 0),
        MENU_DESCR(1, 0, menu_text_di_out_6, 0, 0, 0, 0, 0),
            MENU_DESCR(2, APP_REG_ID_DIGITAL_IN_SELECT6, menu_text_sel, 0, 0, 0, 0, &menu_val_digital_in_select),
            MENU_DESCR(2, APP_REG_ID_DIGITAL_IN_INVERT6, menu_text_inv, 0, 0, 0, 0, &menu_val_digital_inversion),
            MENU_DESCR(2, 0, menu_text_flt, 0, 0, 0, 0, 0),
        MENU_DESCR(1, 0, menu_text_di_out_7, 0, 0, 0, 0, 0),
            MENU_DESCR(2, APP_REG_ID_DIGITAL_IN_SELECT7, menu_text_sel, 0, 0, 0, 0, &menu_val_digital_in_select),
            MENU_DESCR(2, APP_REG_ID_DIGITAL_IN_INVERT7, menu_text_inv, 0, 0, 0, 0, &menu_val_digital_inversion),
            MENU_DESCR(2, 0, menu_text_flt, 0, 0, 0, 0, 0),
        MENU_DESCR(1, 0, menu_text_di_out_8, 0, 0, 0, 0, 0),
            MENU_DESCR(2, APP_REG_ID_DIGITAL_IN_SELECT8, menu_text_sel, 0, 0, 0, 0, &menu_val_digital_in_select),
            MENU_DESCR(2, APP_REG_ID_DIGITAL_IN_INVERT8, menu_text_inv, 0, 0, 0, 0, &menu_val_digital_inversion),
            MENU_DESCR(2, 0, menu_text_flt, 0, 0, 0, 0, 0),
        MENU_DESCR(1, 0, menu_text_di_out_9, 0, 0, 0, 0, 0),
            MENU_DESCR(2, APP_REG_ID_DIGITAL_IN_SELECT9, menu_text_sel, 0, 0, 0, 0, &menu_val_digital_in_select),
            MENU_DESCR(2, APP_REG_ID_DIGITAL_IN_INVERT9, menu_text_inv, 0, 0, 0, 0, &menu_val_digital_inversion),
            MENU_DESCR(2, 0, menu_text_flt, 0, 0, 0, 0, 0),
        MENU_DESCR(1, 0, menu_text_di_out_10, 0, 0, 0, 0, 0),
            MENU_DESCR(2, APP_REG_ID_DIGITAL_IN_SELECT10, menu_text_sel, 0, 0, 0, 0, &menu_val_digital_in_select),
            MENU_DESCR(2, APP_REG_ID_DIGITAL_IN_INVERT10, menu_text_inv, 0, 0, 0, 0, &menu_val_digital_inversion),
            MENU_DESCR(2, 0, menu_text_flt, 0, 0, 0, 0, 0),
        MENU_DESCR(1, 0, menu_text_di_out_11, 0, 0, 0, 0, 0),
            MENU_DESCR(2, APP_REG_ID_DIGITAL_IN_SELECT11, menu_text_sel, 0, 0, 0, 0, &menu_val_digital_in_select),
            MENU_DESCR(2, APP_REG_ID_DIGITAL_IN_INVERT11, menu_text_inv, 0, 0, 0, 0, &menu_val_digital_inversion),
            MENU_DESCR(2, 0, menu_text_flt, 0, 0, 0, 0, 0),
        MENU_DESCR(1, 0, menu_text_di_out_12, 0, 0, 0, 0, 0),
            MENU_DESCR(2, APP_REG_ID_DIGITAL_IN_SELECT12, menu_text_sel, 0, 0, 0, 0, &menu_val_digital_in_select),
            MENU_DESCR(2, APP_REG_ID_DIGITAL_IN_INVERT12, menu_text_inv, 0, 0, 0, 0, 0),
            MENU_DESCR(2, 0, menu_text_flt, 0, 0, 0, 0, 0),
        MENU_DESCR(1, 0, menu_text_di_out_13, 0, 0, 0, 0, 0),
            MENU_DESCR(2, APP_REG_ID_DIGITAL_IN_SELECT13, menu_text_sel, 0, 0, 0, 0, &menu_val_digital_in_select),
            MENU_DESCR(2, APP_REG_ID_DIGITAL_IN_INVERT13, menu_text_inv, 0, 0, 0, 0, &menu_val_digital_inversion),
            MENU_DESCR(2, 0, menu_text_flt, 0, 0, 0, 0, 0),
        MENU_DESCR(1, 0, menu_text_di_out_14, 0, 0, 0, 0, 0),
            MENU_DESCR(2, APP_REG_ID_DIGITAL_IN_SELECT14, menu_text_sel, 0, 0, 0, 0, &menu_val_digital_in_select),
            MENU_DESCR(2, APP_REG_ID_DIGITAL_IN_INVERT14, menu_text_inv, 0, 0, 0, 0, &menu_val_digital_inversion),
            MENU_DESCR(2, 0, menu_text_flt, 0, 0, 0, 0, 0),
    MENU_DESCR(0, 0, menu_text_do, 0, 0, 0, 0, 0),
        MENU_DESCR(1, 0, menu_text_do_out_0, 0, 0, 0, 0, 0),
            MENU_DESCR(2, APP_REG_ID_DIGITAL_OUT_SELECT0, menu_text_sel, 0, 0, 0, 0, &menu_val_digital_out_select),
            MENU_DESCR(2, 0, menu_text_inv, 0, 0, 0, 0, &menu_val_digital_inversion),
            MENU_DESCR(2, 0, menu_text_flt, 0, 0, 0, 0, 0),
        MENU_DESCR(1, 0, menu_text_do_out_1, 0, 0, 0, 0, 0),
            MENU_DESCR(2, APP_REG_ID_DIGITAL_OUT_SELECT1, menu_text_sel, 0, 0, 0, 0, &menu_val_digital_out_select),
            MENU_DESCR(2, 0, menu_text_inv, 0, 0, 0, 0, &menu_val_digital_inversion),
            MENU_DESCR(2, 0, menu_text_flt, 0, 0, 0, 0, 0),
        MENU_DESCR(1, 0, menu_text_do_out_2, 0, 0, 0, 0, 0),
            MENU_DESCR(2, APP_REG_ID_DIGITAL_OUT_SELECT2, menu_text_sel, 0, 0, 0, 0, &menu_val_digital_out_select),
            MENU_DESCR(2, 0, menu_text_inv, 0, 0, 0, 0, &menu_val_digital_inversion),
            MENU_DESCR(2, 0, menu_text_flt, 0, 0, 0, 0, 0),
        MENU_DESCR(1, 0, menu_text_do_out_3, 0, 0, 0, 0, 0),
            MENU_DESCR(2, APP_REG_ID_DIGITAL_OUT_SELECT3, menu_text_sel, 0, 0, 0, 0, &menu_val_digital_out_select),
            MENU_DESCR(2, 0, menu_text_inv, 0, 0, 0, 0, &menu_val_digital_inversion),
            MENU_DESCR(2, 0, menu_text_flt, 0, 0, 0, 0, 0),
        MENU_DESCR(1, 0, menu_text_do_out_4, 0, 0, 0, 0, 0),
            MENU_DESCR(2, APP_REG_ID_DIGITAL_OUT_SELECT4, menu_text_sel, 0, 0, 0, 0, &menu_val_digital_out_select),
            MENU_DESCR(2, 0, menu_text_inv, 0, 0, 0, 0, &menu_val_digital_inversion),
            MENU_DESCR(2, 0, menu_text_flt, 0, 0, 0, 0, 0),
        MENU_DESCR(1, 0, menu_text_do_out_5, 0, 0, 0, 0, 0),
            MENU_DESCR(2, APP_REG_ID_DIGITAL_OUT_SELECT5, menu_text_sel, 0, 0, 0, 0, &menu_val_digital_out_select),
            MENU_DESCR(2, 0, menu_text_inv, 0, 0, 0, 0, &menu_val_digital_inversion),
            MENU_DESCR(2, 0, menu_text_flt, 0, 0, 0, 0, 0),
        MENU_DESCR(1, 0, menu_text_do_out_6, 0, 0, 0, 0, 0),
            MENU_DESCR(2, APP_REG_ID_DIGITAL_OUT_SELECT6, menu_text_sel, 0, 0, 0, 0, &menu_val_digital_out_select),
            MENU_DESCR(2, 0, menu_text_inv, 0, 0, 0, 0, &menu_val_digital_inversion),
            MENU_DESCR(2, 0, menu_text_flt, 0, 0, 0, 0, 0),
        MENU_DESCR(1, 0, menu_text_do_out_7, 0, 0, 0, 0, 0),
            MENU_DESCR(2, APP_REG_ID_DIGITAL_OUT_SELECT7, menu_text_sel, 0, 0, 0, 0, &menu_val_digital_out_select),
            MENU_DESCR(2, 0, menu_text_inv, 0, 0, 0, 0, &menu_val_digital_inversion),
            MENU_DESCR(2, 0, menu_text_flt, 0, 0, 0, 0, 0),
        MENU_DESCR(1, 0, menu_text_do_out_8, 0, 0, 0, 0, 0),
            MENU_DESCR(2, APP_REG_ID_DIGITAL_OUT_SELECT8, menu_text_sel, 0, 0, 0, 0, &menu_val_digital_out_select),
            MENU_DESCR(2, 0, menu_text_inv, 0, 0, 0, 0, &menu_val_digital_inversion),
            MENU_DESCR(2, 0, menu_text_flt, 0, 0, 0, 0, 0),
        MENU_DESCR(1, 0, menu_text_do_out_9, 0, 0, 0, 0, 0),
            MENU_DESCR(2, APP_REG_ID_DIGITAL_OUT_SELECT9, menu_text_sel, 0, 0, 0, 0, &menu_val_digital_out_select),
            MENU_DESCR(2, 0, menu_text_inv, 0, 0, 0, 0, &menu_val_digital_inversion),
            MENU_DESCR(2, 0, menu_text_flt, 0, 0, 0, 0, 0),
        MENU_DESCR(1, 0, menu_text_do_out_10, 0, 0, 0, 0, 0),
            MENU_DESCR(2, APP_REG_ID_DIGITAL_OUT_SELECT10, menu_text_sel, 0, 0, 0, 0, &menu_val_digital_out_select),
            MENU_DESCR(2, 0, menu_text_inv, 0, 0, 0, 0, &menu_val_digital_inversion),
            MENU_DESCR(2, 0, menu_text_flt, 0, 0, 0, 0, 0),
        MENU_DESCR(1, 0, menu_text_do_out_11, 0, 0, 0, 0, 0),
            MENU_DESCR(2, APP_REG_ID_DIGITAL_OUT_SELECT11, menu_text_sel, 0, 0, 0, 0, &menu_val_digital_out_select),
            MENU_DESCR(2, 0, menu_text_inv, 0, 0, 0, 0, &menu_val_digital_inversion),
            MENU_DESCR(2, 0, menu_text_flt, 0, 0, 0, 0, 0),
};
